export const ja = {
  ...
  // About detailed text
  about_intro: "こんにちは！私は{realname}と申します。ベトナム出身の{age}開発者で、現在{university}で学んでいます。{web}と{ai_fields}の力を通じて、{life}をより簡単で効率的にする実用的な{products}を構築することに情熱を持っています。",
  about_journey: "高校時代からプログラミングを始めました。一行のコードがどのようにして機能するシステム全体を作り出すのかに興味を持っていました。時が経つにつれ、その好奇心は、{stages}までの完全な製品を作り出すことへの本物の{passion}へと変わりました。プログラミングで最も気に入っているのは技術的な側面だけでなく、{feeling}して、他の人が実際に使っているのを見ることです。",
  about_philosophy: "私の仕事哲学は{philosophy}です。良い製品は複雑である必要はなく、ただ{needs}だけでいいと信じています。常にクリーンで簡潔で効率的なコーディングスタイルを維持し、{combination}を組み合わせて完全なユーザー体験を提供することを心がけています。",
  about_current_project: "現在、ベトナムのユーザー向けにAIツールを集約したプラットフォーム{vnlotus}を開発しています。{features}が含まれています。私の目標は、Vnlotusを{goal}場所にすることで、{spirit}の精神に従っています。",
  about_vision: "将来は、コーディングがうまいだけでなく、製品、ユーザー、持続可能な開発を理解できる{future_role}になりたいです。テクノロジーが本当に人々の生活をポジティブに変える{meaningful_projects}に参加したいと思っています。",
  about_conclusion: "私にとって、{motto}です。それが私がこの道を選んだ理由です。",
  ...
  project_growfund_desc: "技術製品のアウトソース開発・保守、GrowFundAIプロジェクト（100以上のオンラインツール）およびベトナム開発者向けプログラミングプラットフォームCodino開発支援。",
  ...
  project_growfund_long: "技術製品のアウトソース開発・保守、GrowFundAIプロジェクト（100以上のオンラインツール）およびベトナム開発者向けプログラミングプラットフォームCodino開発支援。",
  // Project categories
  ...
  highlight_age: "18歳の",
  highlight_university: "タイグエン情報通信技術大学（ICTU）",
  highlight_products: "技術製品",
  highlight_life: "人々の生活",
  highlight_passion: "情熱",
  highlight_stages: "アイデア、設計からエンドユーザー体験まで",
  highlight_feeling: "アイデアを現実に変える",
  highlight_philosophy: "シンプルで、最適化され、目的志向",
  highlight_needs: "正しい問題を解決し、迅速かつ可能な限りユーザーフレンドリー",
  highlight_combination: "技術的思考とデザイン感覚",
  highlight_vnlotus: "Vnlotus",
  highlight_features: "AI Chat、AI Tools、AI Models、AI Trending",
  highlight_goal: "人々が仕事や日常生活でAIに簡単にアクセスし、学び、応用できる",
  highlight_spirit: "「すべての人のためのAI」",
  highlight_future_role: "包括的なフルスタック開発者",
  highlight_meaningful_projects: "社会的に意義のあるプロジェクト",
  highlight_motto: "すべてのコード行は、より良い世界を築く小さなレンガである",
