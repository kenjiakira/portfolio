export const vi = {
  ...
  value_innovation_desc: "Luôn khám phá những công nghệ tiên tiến",
  value_quality_title: "Chất Lượng",
  value_quality_desc: "Viết code sạch, dễ bảo trì",
  value_collaboration_title: "Hợp Tác",
