export const vi = {
  ...
  // About detailed text
  about_intro: "Xin chào! Mình là {realname}, một lập trình viên trẻ {age} đến từ Việt Nam, hiện đang theo học tại {university}. Mình đam mê xây dựng {products} thực tế, đặc biệt là những sản phẩm có thể giúp {life} trở nên dễ dàng và hiệu quả hơn thông qua sức mạnh của {web} và {ai_fields}.",
  about_journey: "Mình bắt đầu lập trình từ khi còn học phổ thông, với niềm tò mò về cách một dòng code có thể tạo nên cả một hệ thống hoạt động. Qua thời gian, niềm tò mò đó trở thành {passion} thật sự với việc tạo ra sản phẩm hoàn chỉnh, từ {stages}. Điều mình yêu thích nhất ở lập trình không chỉ là kỹ thuật, mà là cảm giác {feeling} và thấy người khác thật sự sử dụng sản phẩm của mình.",
  about_philosophy: "Triết lý làm việc của mình là {philosophy}. Mình tin rằng một sản phẩm tốt không nhất thiết phải phức tạp — nó chỉ cần {needs}. Mình luôn cố gắng duy trì phong cách lập trình sạch, tinh gọn và hiệu quả, kết hợp giữa {combination} để mang lại trải nghiệm hoàn chỉnh cho người dùng.",
  about_current_project: "Hiện tại, mình đang phát triển {vnlotus} – nền tảng tổng hợp các công cụ AI dành cho người Việt, bao gồm {features}. Mục tiêu của mình là biến Vnlotus thành một nơi giúp {goal}, theo đúng tinh thần {spirit}.",
  about_vision: "Trong tương lai, mình muốn trở thành một {future_role}, có khả năng không chỉ lập trình giỏi mà còn hiểu sản phẩm, người dùng và hướng phát triển bền vững. Mình mong muốn được tham gia vào {meaningful_projects}, nơi công nghệ thật sự giúp thay đổi cuộc sống con người theo hướng tích cực.",
  about_conclusion: "Với mình, {motto} — và đó là lý do mình chọn theo con đường này.",
  ...
  highlight_web: "web",
  highlight_ai_fields: "AI",
  highlight_age: "18 tuổi",
  highlight_university: "Đại học CNTT & Truyền thông Thái Nguyên (ICTU)",
  highlight_products: "sản phẩm công nghệ",
  highlight_life: "cuộc sống con người",
  highlight_passion: "đam mê",
  highlight_stages: "ý tưởng, thiết kế đến trải nghiệm người dùng cuối",
  highlight_feeling: "biến ý tưởng thành hiện thực",
  highlight_philosophy: "đơn giản, tối ưu và có mục đích rõ ràng",
  highlight_needs: "giải quyết đúng vấn đề, nhanh chóng và thân thiện nhất",
  highlight_combination: "tư duy kỹ thuật và cảm quan thiết kế",
  highlight_vnlotus: "Vnlotus",
  highlight_features: "AI Chat, AI Tools, AI Models và AI Trending",
  highlight_goal: "mọi người dễ dàng tiếp cận, học hỏi và ứng dụng AI trong công việc lẫn đời sống hàng ngày",
  highlight_spirit: "\"AI cho tất cả\"",
  highlight_future_role: "kỹ sư phần mềm toàn diện (fullstack developer)",
  highlight_meaningful_projects: "các dự án có ý nghĩa xã hội",
  highlight_motto: "mỗi dòng code là một viên gạch nhỏ xây nên thế giới tốt đẹp hơn",
