export const en = {
  ...
  // About detailed text
  about_intro: "Hello! I'm {realname}, a {age} developer from Vietnam, currently studying at {university}. I'm passionate about building real-world {products}, especially those that can help make {life} easier and more efficient through the power of {web} and {ai_fields}.",
  about_journey: "I started programming in high school, curious about how a line of code could create an entire working system. Over time, that curiosity became a genuine {passion} for creating complete products, from {stages}. What I love most about programming isn't just the technical aspect, but the feeling of {feeling} and seeing others actually use what I've built.",
  about_philosophy: "My work philosophy is {philosophy}. I believe a good product doesn't have to be complex — it just needs to {needs}. I always strive to maintain clean, concise, and efficient coding style, combining {combination} to deliver complete user experiences.",
  about_current_project: "Currently, I'm developing {vnlotus} – a platform aggregating AI tools for Vietnamese users, including {features}. My goal is to make Vnlotus a place that helps {goal}, following the spirit of {spirit}.",
  about_vision: "In the future, I want to become a {future_role}, capable of not just coding well but also understanding products, users, and sustainable development. I hope to participate in {meaningful_projects}, where technology truly helps change people's lives positively.",
  about_conclusion: "For me, {motto} — and that's why I chose this path.",
  ...
  highlight_age: "18-year-old",
  highlight_university: "Thái Nguyên University of Information and Communication Technology (ICTU)",
  highlight_products: "technology products",
  highlight_life: "people's lives",
  highlight_passion: "passion",
  highlight_stages: "ideation, design to end-user experience",
  highlight_feeling: "turning ideas into reality",
  highlight_philosophy: "simple, optimized, and purpose-driven",
  highlight_needs: "solve the right problem, quickly and as user-friendly as possible",
  highlight_combination: "technical thinking and design sensibility",
  highlight_vnlotus: "Vnlotus",
  highlight_features: "AI Chat, AI Tools, AI Models, and AI Trending",
  highlight_goal: "people easily access, learn, and apply AI in both work and daily life",
  highlight_spirit: "\"AI for Everyone\"",
  highlight_future_role: "comprehensive fullstack developer",
  highlight_meaningful_projects: "socially meaningful projects",
  highlight_motto: "every line of code is a small brick building a better world",
